...
namespace WinFormsApp1
{
    public partial class VehiculosForms : Form
    {
        ...
        private void bt_guardar_Click(object sender, EventArgs e)
        {
            ...
            // Validación del tipo de dato utilizado
            int año, kilometraje;
            decimal precio;
        ...
        private void eliminarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                Vehiculo vehiculo_eliminar = GlobalVar.Inventario.Lista().Where(v => v.Marca == vehiculoMarca && v.Modelo == vehiculoModelo).FirstOrDefault();
            ...
            {
                MessageBox.Show("SELECCIONA UN VEHICULO PARA ELIMINAR.");
            }
        }
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                string vehiculoMarca = listView1.SelectedItems[0].SubItems[3].Text;
                string vehiculoModelo = listView1.SelectedItems[0].SubItems[4].Text;

                vehiculoSeleccionado = GlobalVar.Inventario.Lista().Where(v => v.Marca == vehiculoMarca && v.Modelo == vehiculoModelo).FirstOrDefault();
            }
        }
        private void modificarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                Vehiculo vehiculo_modificar = GlobalVar.Inventario.Lista().Where(v => v.Id == vehiculoId).FirstOrDefault();

                if (vehiculo_modificar != null)
                {
                    // Llenar los campos para editar el vehículo
            ...
            {
                MessageBox.Show("SELECCIONA UN VEHICULO PARA MODIFICAR.");
            }
        }
    }
}